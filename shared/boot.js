...
(function () {
  ...
  const MAP = { planner: 'PlannerView', money: 'MoneyView', books: 'BooksView', articles: 'ArticlesView', english: 'EnglishView', investment: 'InvestmentView', rent: 'RentView', university: 'UniversityView' };
