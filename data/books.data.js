...
window.BOOKS_DATA = {
  ...
  "books": [
    ...
    {"id":"b0002","title":"จวบระพีอัสดง","author":"Jacaranda K.","status":"done",
     "genre":"วาย พีเรียด","format":"physical","totalPages":352,"currentPage":352,"progressPct":null,
     "dateAdded":"2026-07-13","startDate":null,"finishDate":"2026-07-13",
     "rating":5,"review":"","cover":"https://1568886761.rsc.cdn77.org/books/36274/Thumbnail/large.gif?2",
     "synopsis":"เรื่องราวของระพี ดิเรกโยธิน บุตรชายจากเมียบ่าวที่เติบโตในสถานะด้อยกว่าพี่น้องในตระกูล กับนรินทร์ บ่าวหนุ่มผู้มีจิตใจบริสุทธิ์ ทั้งคู่ผูกพันกันลึกซึ้งผ่านความรักในหนังสือ ท่ามกลางกำแพงชนชั้นและเพศสภาพ ในช่วงเวลาที่บ้านเมืองกำลังผันผวนจากการเปลี่ยนแปลงการปกครองจนถึงสงครามโลกครั้งที่สอง"}
  ]
};
