  ...
  "portfolioReviews": [
    {
      "id": "pr0001",
      "date": "2026-07-22",
      "holdingsRaw": "หุ้นสหรัฐฯ: AEHR (Aehr Test Systems) 0.4779970 หุ้น ต้นทุนเฉลี่ย 65.90 USD/หุ้น ต้นทุนรวม 31.50 USD มูลค่าปัจจุบัน 47.28 USD (≈1,591.40 THB ที่ 1 USD = 33.66 THB) กำไรลอยตัว +50.09% (+15.78 USD), ราคาหุ้นวันนี้ +27.86%; เงินสด 500 THB; ทองคำ 1,000 THB",
      "snapshot": "พอร์ตนี้มีมูลค่ารวมประมาณ 3,091 บาท (ราว 92 ดอลลาร์สหรัฐฯ) แบ่งเป็นหุ้นสหรัฐฯ 51.5%, ทองคำ 32.3% และเงินสด 16.2% ฝั่งหุ้นสหรัฐฯ มีสินทรัพย์เดียวคือ AEHR (Aehr Test Systems) ถือ 0.478 หุ้น ต้นทุนเฉลี่ย 65.90 ดอลลาร์/หุ้น กำไรลอยตัวปัจจุบัน +50.09% (+15.78 ดอลลาร์) หลังราคาพุ่ง 27.86% ในวันเดียวจากข่าวผลประกอบการ พอร์ตมี concentration (การกระจุกตัว) สูงมาก เพราะสินทรัพย์ตัวเดียวครองกว่าครึ่งพอร์ต และไม่มี ETF หรือหุ้นตัวอื่นถ่วงดุลเลยนอกจากทองคำกับเงินสด",
      "allocation": [
      ...
      "positives": [
        ...
        {"label": "ทองคำถ่วงดุลความผันผวน", "note": "สัดส่วนทองคำ 32% ในพอร์ตเล็กช่วยถ่วงดุลกับหุ้นเทคโนโลยี/เซมิคอนดักเตอร์ความผันผวนสูงได้ในทางทฤษฎี เพราะทองคำมักไม่เคลื่อนไหวทิศทางเดียวกับหุ้น small-cap แบบ AEHR"},
        {"label": "มีเงินสดสำรอง", "note": "เงินสด 16% เป็นกันชนสภาพคล่อง เผื่อจังหวะเข้าเพิ่มหรือรับความผันผวนช่วงตลาดปั่นป่วนจากสงคราม/ผลประกอบการ Big Tech สัปดาห์นี้"}
      ],
      "concerns": [
        {"label": "Concentration risk รุนแรง", "note": "หุ้นตัวเดียว (AEHR) ครองกว่าครึ่งพอร์ต และเป็น small-cap ที่เพิ่งพุ่งแรงจากข่าวเดียว (earnings beat) หากไตรมาสถัดไปทำไม่ได้ตาม guidance ที่ตั้งไว้สูงมาก (160-200% growth) แรงขายกลับก็รุนแรงพอกัน"},
        ...
        {"label": "ไม่มีการกระจายความเสี่ยงจริง", "note": "นอกจากทองคำกับเงินสด พอร์ตไม่มี ETF ตลาดกว้างหรือหุ้นอื่นถ่วงดุลเลย ผลตอบแทนทั้งพอร์ตแทบผูกกับชะตาของหุ้นตัวเดียวและราคาทองคำเท่านั้น"}
      ],
      "discussion": [
        ...
        "เป้าหมายของทองคำ 32% ในพอร์ตนี้คือ hedge ความผันผวน หรือเก็งกำไรตามเทรนด์ราคา เพราะสองแบบนี้มีจุดตัดสินใจขาย/ถือต่อไม่เหมือนกัน",
        "พอร์ตนี้ตั้งใจขยายขนาด/กระจายไปยังสินทรัพย์อื่นเมื่อไหร่ หรือให้เป็นพอร์ตทดลอง (satellite) ขนาดเล็กที่รับความเสี่ยงสูงเต็มที่ต่อไป",
        "มีระดับที่จะ trim สัดส่วน AEHR ลงไหม หากราคายังวิ่งต่อจนสัดส่วนในพอร์ตพุ่งสูงกว่านี้อีก"
      ],
      "caveats": "การวิเคราะห์นี้อ้างอิงข้อมูล holdings ที่ให้มา ณ วันที่ 22 ก.ค. 2026 (มูลค่า AEHR แปลงจาก USD เป็น THB ที่อัตรา 1 USD = 33.66 บาทตามที่แสดงในแอป) และข้อมูล macro/ข่าวที่ค้นสด ณ วันเดียวกัน เป็นมุมมองเชิงคุณภาพเพื่อประกอบการตัดสินใจเท่านั้น ไม่ใช่คำแนะนำการลงทุนโดยตรง ไม่ได้คำนวณตัวชี้วัดเชิงปริมาณ เช่น VaR/Sharpe/beta และไม่ได้พยากรณ์ราคาล่วงหน้า"
    }
  ]
};
