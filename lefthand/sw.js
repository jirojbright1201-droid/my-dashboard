// Left Hand PWA service worker (scope: /lefthand/)
const CACHE = 'lefthand-v1';
const CORE = [
  './', './index.html', './manifest.webmanifest',
  '../app.css', '../shared/boot.js',
  '../data/lefthand.data.js', '../views/lefthand.js', '../views/lefthand.css',
  '../views/capture.js', '../views/capture.css',
  '../icons/lefthand-192.png', '../icons/lefthand-512.png'
];
