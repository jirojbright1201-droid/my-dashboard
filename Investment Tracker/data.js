...
const DATA = {
  ...
  thesis:[
    {cat:'AI Networking', t:'NOK — Nokia: คนวางเสากับสายให้อินเทอร์เน็ตทั้งโลก แต่เงินกำไรซ่อนอยู่ในสิทธิบัตร', updated:'18 มิ.ย. 2026',
     sum:'Nokia เลิกทำมือถือไปนานแล้ว ทุกวันนี้ขายเสาสัญญาณ 5G กับสายส่งข้อมูลให้บริษัทมือถือและศูนย์ข้อมูลทั่วโลก (รายได้ ~€19.9B/ปี). แต่ของที่ขายได้เยอะกลับกำไรบางมาก — เงินกำไรเกือบครึ่งบริษัทมาจากการเก็บค่าสิทธิบัตร ก้อนที่เป็นรายได้แค่ 8% แต่กำไรถึง 70%',
     full:'ถ้าพูดชื่อ Nokia คนส่วนใหญ่นึกถึงโทรศัพท์ปุ่มกดเครื่องอึด แต่นั่นคือ Nokia เมื่อสิบกว่าปีก่อน.\nNokia ขายธุรกิจมือถือทิ้งตั้งแต่ปี 2014 (โทรศัพท์ยี่ห้อ Nokia ที่ยังเห็นในร้านคือบริษัท HMD เช่าชื่อไปทำ). วันนี้มันคือคนขายของที่อยู่เบื้องหลังทุกครั้งที่เราเปิดมือถือ — เสาสัญญาณ 5G, เราเตอร์, สายใยแก้วที่ส่งข้อมูลข้ามทวีป — ให้บริษัทโทรคมนาคมและศูนย์ข้อมูลทั่วโลก. รายได้รวมราว €19.9B ในปี 2025.\nแล้วเรื่องที่คนไม่ค่อยรู้ก็คือ Nokia ขายอุปกรณ์ได้ยอดเยอะ (เสา 5G กับเราเตอร์รวมกัน ~80% ของรายได้) แต่แทบไม่ได้กำไรจากตรงนั้นเลย — เสา 5G ทำกำไรแค่ 2.8%. เงินกำไรตัวจริงเกือบครึ่งบริษัทมาจากก้อนเล็กๆ ชื่อ Nokia Technologies ซึ่งก็คือการนั่งเก็บค่าลิขสิทธิ์สิทธิบัตรไร้สาย ที่ผู้ผลิตมือถือทั้งโลก (รวม Apple, Samsung) ต้องจ่าย. ก้อนนี้เป็นรายได้แค่ 8% แต่กำไรถึง 70%. พูดง่ายๆ Nokia ทำเงินจากการเป็นเจ้าของไอเดีย มากกว่าการขายของ. (ที่มา: Nokia Q4/FY2025 ผ่าน stocktitan)\nทำไมลูกค้าไม่ย้ายหนีง่ายๆ: เพราะเปลี่ยนยี่ห้อเสากลางทางมันแพง เสี่ยงเครือข่ายล่ม ต้องรื้อทดสอบใหม่หมด บวกกับโลกตะวันตกกัน Huawei ออก เลยเหลือ Nokia กับ Ericsson เป็นตัวเลือก. แต่ก็ไม่ใช่การล็อกลูกค้าแบบเด็ดขาด — บริษัทมือถือจงใจใช้หลายเจ้าเพื่อกดราคา และเคยเสียดีลใหญ่อย่าง AT&T ให้ Ericsson มาแล้ว.\nเรื่องเล่าใหม่ที่ทำให้หุ้นกลับมาร้อน: AI. ปลายปี 2025 NVIDIA ลงเงิน $1B ถือหุ้น 2.9% และ Nokia ซื้อบริษัท optical ชื่อ Infinera เพื่อบุกตลาดเครือข่ายศูนย์ข้อมูล AI โดยมี CEO ใหม่สายเซิร์ฟเวอร์ AI มาคุม. แต่ในงบจริงวันนี้ ตัวที่โตคือ optical/IP ส่วนรายได้จาก AI ยังเป็นก้อนเล็กที่เพิ่งเริ่ม.\nสิ่งที่ต้องจับตา: (1) รายได้ AI/ศูนย์ข้อมูลจะกลายเป็นของจริงในงบไหม ในสนามที่ Arista/Cisco แข็งกว่า (2) ธุรกิจเสา 5G ที่ตลาดอิ่มแล้วจะทรุดก่อน 6G มาถึงหรือเปล่า (3) จะต่อสัญญาสิทธิบัตรก้อนกำไรหลักได้ต่อเนื่องไหม. รายงานนี้เข้าใจ \'ธุรกิจ\' อย่างเดียว ไม่ทำ valuation ไม่แนะนำซื้อ-ขาย.',
     sections:[
       {h:'ทำเงินจากอะไร', b:'รายได้ ~€19.9B (2025) มาจาก 4 ขา: เราเตอร์กับสายใยแก้ว (Network Infrastructure) ~40% ที่กำลังโต +9%, เสาสัญญาณ 5G (Mobile Networks) ~39% ที่ทรงตัว, ซอฟต์แวร์เครือข่าย ~13%, และค่าสิทธิบัตร ~8%. แต่กำไรกระจุกอยู่ที่เดียว — ค่าสิทธิบัตรทำกำไร €1,059M ด้วย margin 70% คิดเป็นเกือบครึ่งของกำไรทั้งบริษัท ขณะที่เสา 5G ทำกำไรแค่ 2.8%. ขายของได้เยอะ แต่เงินจริงมาจากการเก็บค่าลิขสิทธิ์. (ที่มา: Nokia Q4/FY2025 ผ่าน stocktitan)'},
       {h:'ทำไมลูกค้าไม่ย้าย', b:'การเปลี่ยนยี่ห้อเสากลางทางทั้งแพงและเสี่ยง ลูกค้าเลยไม่อยากย้ายง่ายๆ บวกกับโลกตะวันตกกัน Huawei ออก เหลือ Nokia กับ Ericsson เป็นตัวเลือกหลัก. แต่ความเหนียวนี้ไม่สมบูรณ์ — บริษัทมือถือจงใจใช้หลายเจ้าเพื่อกดราคา และมาตรฐานใหม่อย่าง Open RAN ก็เปิดให้ผสมยี่ห้อได้ (Nokia เคยเสียดีล AT&T ให้ Ericsson). ป้อมปราการที่แข็งจริงมีอันเดียวคือคลังสิทธิบัตรไร้สายราว 20,000 ชุด ที่ทุกคนต้องจ่ายค่าใช้. ส่วนในตลาดเสา 5G เอง Nokia เป็นแค่เบอร์ 3 รองจาก Huawei กับ Ericsson.'},
       {h:'เครื่องยนต์โต', b:'หนึ่ง เครือข่ายศูนย์ข้อมูล AI — ดีล NVIDIA ($1B, หุ้น 2.9%) บวกการซื้อ Infinera เปิดทางให้ Nokia ขาย optical/switching ให้ศูนย์ข้อมูล AI แต่ Nokia เป็นผู้มาทีหลังในสนามที่ Arista/Cisco แข็งอยู่. สอง optical/IP ที่โตจริงในงบแล้ว (ตั้งเป้าโต 6-8% ปี 2026). สาม ค่าสิทธิบัตรที่ขยายไปรถยนต์/IoT (เป้ายอดประจำขยับจาก €1.3B เป็น 1.4-1.5B ด้วย margin 70%). บริษัทตั้งเป้าดันกำไรขึ้นเป็น €2.7-3.2B ภายในปี 2028 จากราว €2.0B แต่ต้องแลกด้วยงบวิจัยที่สูงราว €4.6B ต่อปี.'},
       {h:'ความเสี่ยงหลัก', b:'หนึ่ง ธุรกิจหลักกำไรบางและตลาด 5G อิ่มตัว ถ้ารอบลงทุน 5G จบก่อน 6G จะมา รายได้ก้อนใหญ่ทรุด. สอง การบุก AI อาจไม่เป็นจริงตามที่เล่า เพราะสนามศูนย์ข้อมูลมี Arista/Cisco/NVIDIA แข็งอยู่ ถ้าแย่งส่วนแบ่งไม่ได้จริง ความคาดหวังที่ตลาดให้ราคาไว้จะพัง. สาม รายได้ค่าสิทธิบัตรขึ้นลงตามรอบต่อสัญญา ซึ่งเป็นก้อนกำไรหลัก ถ้าสะดุดกำไรรวมสะเทือนแรง. สี่ ความได้เปรียบ \'ฝั่งตะวันตก\' พึ่งนโยบายกัน Huawei ถ้านโยบายเปลี่ยนก็เสียเปรียบทันที.'},
       {h:'สิ่งที่คนเข้าใจผิด', b:'คนส่วนใหญ่ยังคิดว่า Nokia คือบริษัทมือถือเก่าที่ล้มไปแล้ว / ทำเงินจากการขายอุปกรณ์ 5G / หรือเป็นหุ้น AI เต็มตัว. ความจริงคือ Nokia เป็นบริษัทขายโครงสร้างพื้นฐานเครือข่ายให้องค์กร ที่กำไรเกือบครึ่งมาจากการเก็บค่าสิทธิบัตร ส่วนเรื่อง AI ยังเป็นเรื่องเล่าของอนาคต ไม่ใช่ภาพในงบวันนี้. และจุดแข็งตัวจริงไม่ใช่อุปกรณ์ที่เหนือกว่า (เป็นแค่เบอร์ 3 ในตลาดเสา 5G) แต่คือสิทธิบัตรกับจังหวะทางภูมิรัฐศาสตร์.'}
     ]}
  ],
  timeline:[
