...
const DATA = {
  holdings: [
    {tk:'MU', name:'Micron', sector:'Semiconductors', shares:5, avg:98, price:142.10, prev:139.0, about:'ผู้ผลิตชิปหน่วยความจำ DRAM และ NAND รายใหญ่ของสหรัฐ เป็น 1 ใน 3 เจ้าของโลกที่ผลิต HBM สำหรับ AI ได้ ได้ประโยชน์ตรงจาก memory cycle ขาขึ้นและดีมานด์ AI',
    ...
    {tk:'VST', name:'Vistra', sector:'Energy', shares:3, avg:135, price:168.50, prev:164.2, about:'ผู้ผลิตและค้าปลีกไฟฟ้ารายใหญ่ของสหรัฐ มีทั้งโรงไฟฟ้าก๊าซ นิวเคลียร์ และพลังงานหมุนเวียน ได้ประโยชน์จากดีมานด์ไฟฟ้าของ data center ที่โตตาม AI',
    ...
    {tk:'COHR', name:'Coherent', sector:'Photonics', shares:4, avg:82, price:99.30, prev:97.8, about:'ผู้ผลิต optical component และ transceiver ความเร็วสูง 800G/1.6T สำหรับ networking ใน data center และ AI cluster photonics เป็นคอขวดสำคัญของโครงสร้าง AI รุ่นใหม่',
    ...
    {tk:'CEG', name:'Constellation', sector:'Energy', shares:2, avg:220, price:255.00, prev:251.0, about:'ผู้ผลิตไฟฟ้านิวเคลียร์รายใหญ่ที่สุดของสหรัฐ จ่าย baseload แบบ carbon-free ทำสัญญา PPA ระยะยาวกับ hyperscaler สำหรับป้อนไฟ AI data center',
  ...
  // บริษัทที่ไม่ได้ถือเองตอนนี้ (NOVA ถือ หรือเคยถือแล้วขายทิ้ง) — ข่าวของ NOVA-only ดึงจาก market.holdings_news อัตโนมัติ
  companies:[
