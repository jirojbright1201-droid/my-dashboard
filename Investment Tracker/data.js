...
const DATA = {
  holdings: [
    {tk:'MU', name:'Micron', sector:'Semiconductors', exchange:'NASDAQ', country:'United States', founded:1978, web:'micron.com', shares:5, avg:98, price:142.10, prev:139.0, thesisRef:'Memory', about:'ผู้ผลิตชิปหน่วยความจำ DRAM และ NAND รายใหญ่ของสหรัฐ เป็น 1 ใน 3 เจ้าของโลกที่ผลิต HBM สำหรับ AI ได้ ได้ประโยชน์ตรงจาก memory cycle ขาขึ้นและดีมานด์ AI',
    ...
    {tk:'NVDA', name:'Nvidia', sector:'Semiconductors', exchange:'NASDAQ', country:'United States', founded:1993, web:'nvidia.com', shares:2, avg:128, price:182.40, prev:180.1, about:'ผู้นำ GPU และชิป AI ครองตลาด accelerator สำหรับ training/inference เป็นแกนหลักของ AI compute ทั้งอุตสาหกรรม ทั้งฮาร์ดแวร์และ ecosystem ซอฟต์แวร์ CUDA',
    ...
    {tk:'VST', name:'Vistra', sector:'Energy', exchange:'NYSE', country:'United States', founded:2016, web:'vistracorp.com', shares:3, avg:135, price:168.50, prev:164.2, thesisRef:'Energy', about:'ผู้ผลิตและค้าปลีกไฟฟ้ารายใหญ่ของสหรัฐ มีทั้งโรงไฟฟ้าก๊าซ นิวเคลียร์ และพลังงานหมุนเวียน ได้ประโยชน์จากดีมานด์ไฟฟ้าของ data center ที่โตตาม AI',
    ...
    {tk:'COHR', name:'Coherent', sector:'Photonics', exchange:'NYSE', country:'United States', founded:1971, web:'coherent.com', shares:4, avg:82, price:99.30, prev:97.8, thesisRef:'Photonics', about:'ผู้ผลิต optical component และ transceiver ความเร็วสูง 800G/1.6T สำหรับ networking ใน data center และ AI cluster photonics เป็นคอขวดสำคัญของโครงสร้าง AI รุ่นใหม่',
    ...
    {tk:'CEG', name:'Constellation', sector:'Energy', exchange:'NASDAQ', country:'United States', founded:2022, web:'constellationenergy.com', shares:2, avg:220, price:255.00, prev:251.0, thesisRef:'Energy', about:'ผู้ผลิตไฟฟ้านิวเคลียร์รายใหญ่ที่สุดของสหรัฐ จ่าย baseload แบบ carbon-free ทำสัญญา PPA ระยะยาวกับ hyperscaler สำหรับป้อนไฟ AI data center',
    ...
    {tk:'TSM', name:'TSMC', sector:'Semiconductors', exchange:'NYSE', country:'Taiwan', founded:1987, web:'tsmc.com', shares:2, avg:175, price:205.60, prev:202.0, about:'โรงงานรับผลิตชิป (foundry) เบอร์ 1 ของโลก ผลิตชิปขั้นสูงสุดให้ Apple, Nvidia, AMD ครองเทคโนโลยีระดับ 3nm/2nm กำลังการผลิตเต็มยาว',
    ...
    {tk:'AMD', name:'AMD', sector:'Semiconductors', exchange:'NASDAQ', country:'United States', founded:1969, web:'amd.com', shares:3, avg:150, price:141.20, prev:143.0, about:'ผู้ผลิต CPU และ GPU คู่แข่งหลักของ Intel และ Nvidia ดันชิป Instinct MI series ชิงส่วนแบ่งตลาด AI accelerator ด้วยราคาที่ถูกกว่า',
    ...
    {tk:'AAPL', name:'Apple', sector:'Technology', exchange:'NASDAQ', country:'United States', founded:1976, web:'apple.com', shares:1.5, avg:205, price:198.20, prev:199.5, about:'บริษัทเทคที่มูลค่าสูงสุดในโลก ขาย iPhone/Mac/iPad และบริการ กระแสเงินสดแกร่งและ ecosystem เหนียวแน่น กำลังไล่ตามเรื่อง AI on-device',
