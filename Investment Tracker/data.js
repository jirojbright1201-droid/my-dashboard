...
const DATA = {
  holdings: [
    {tk:'MU', name:'Micron', sector:'Semiconductors', shares:5, avg:98, price:142.10, prev:139.0,
      ...
      news:[{date:'8 มิ.ย.', head:'ราคา HBM ขยับขึ้นต่อ ผู้ผลิตขายล่วงหน้าเต็มถึงปีหน้า', src:'Bloomberg', sum:'ผู้ผลิต HBM รายใหญ่ทั้งหมดขายสินค้าล่วงหน้าเต็มถึงปี 2027 แล้ว ดีมานด์จาก AI cluster รุ่นใหม่ยังพุ่งต่อเนื่อง ราคาต่อ GB คาดปรับขึ้น 15-20% ในไตรมาส Q3 ซึ่งส่งผลดีต่อมาร์จิ้น Micron โดยตรง นักวิเคราะห์ส่วนใหญ่ปรับ PT ขึ้นหลังข่าวนี้', move:{pct:3.1, period:'1 สัปดาห์'}},{date:'20 เม.ย. 2026', head:'Micron รายงานกำไร Q2 FY2026 โต 89% YoY', src:'Reuters', sum:'รายได้จาก HBM ขึ้นเป็น 30% ของยอดรวม ผู้บริหารระบุดีมานด์ยังไม่มีสัญญาณชะลอ กำไรต่อหุ้นสูงกว่า consensus 12% นักวิเคราะห์จากหลายสำนักปรับ price target ขึ้นหลังงบออก', move:{pct:7.8, period:'1 วัน'}},{date:'12 ก.พ. 2026', head:'Micron ได้รับเงิน CHIPS Act $6.1B ยืนยัน fab ใหม่ที่ Idaho', src:'Bloomberg', sum:'กระทรวงพาณิชย์สหรัฐอนุมัติเงินอุดหนุน CHIPS Act $6.1B สำหรับโรงงาน fab ใหม่ที่ Idaho เพิ่มความสามารถแข่งขันระยะยาวกับ Samsung และ SK Hynix ในตลาด DRAM และ HBM', move:{pct:2.4, period:'3 วัน'}}]},
    ...
    {tk:'COHR', name:'Coherent', sector:'Photonics', shares:4, avg:82, price:99.30, prev:97.8,
      ...
      news:[{date:'6 มิ.ย.', head:'คำสั่งซื้อ optical สำหรับ AI cluster พุ่ง', src:'SeekingAlpha', sum:'ยอดสั่งซื้อ 800G transceiver เพิ่มขึ้น 40% QoQ ลูกค้าหลักเป็น hyperscaler ที่กำลัง upgrade network ใน AI cluster รุ่นใหม่ margin โปรดักต์ใหม่สูงกว่ารุ่นเก่าอย่างมีนัยสำคัญ Coherent คาดรายได้ปีนี้โตเกิน 30%', move:{pct:4.3, period:'1 สัปดาห์'}}]},
