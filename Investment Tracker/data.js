...
const DATA = {
  holdings: [
    {tk:'MU', name:'Micron', sector:'Semiconductors', shares:5, avg:98, price:142.10, prev:139.0,
      ...
      news:[{date:'8 มิ.ย.', head:'ราคา HBM ขยับขึ้นต่อ ผู้ผลิตขายล่วงหน้าเต็มถึงปีหน้า', src:'Bloomberg', sum:'ผู้ผลิต HBM รายใหญ่ทั้งหมดขายสินค้าล่วงหน้าเต็มถึงปี 2027 แล้ว ดีมานด์จาก AI cluster รุ่นใหม่ยังพุ่งต่อเนื่อง ราคาต่อ GB คาดปรับขึ้น 15-20% ในไตรมาส Q3 ซึ่งส่งผลดีต่อมาร์จิ้น Micron โดยตรง นักวิเคราะห์ส่วนใหญ่ปรับ PT ขึ้นหลังข่าวนี้'},{date:'20 เม.ย. 2026', head:'Micron รายงานกำไร Q2 FY2026 โต 89% YoY', src:'Reuters', sum:'รายได้จาก HBM ขึ้นเป็น 30% ของยอดรวม ผู้บริหารระบุดีมานด์ยังไม่มีสัญญาณชะลอ กำไรต่อหุ้นสูงกว่า consensus 12% นักวิเคราะห์จากหลายสำนักปรับ price target ขึ้นหลังงบออก'},{date:'12 ก.พ. 2026', head:'Micron ได้รับเงิน CHIPS Act $6.1B ยืนยัน fab ใหม่ที่ Idaho', src:'Bloomberg', sum:'กระทรวงพาณิชย์สหรัฐอนุมัติเงินอุดหนุน CHIPS Act $6.1B สำหรับโรงงาน fab ใหม่ที่ Idaho เพิ่มความสามารถแข่งขันระยะยาวกับ Samsung และ SK Hynix ในตลาด DRAM และ HBM'}]},
    ...
    {tk:'AMD', name:'AMD', sector:'Semiconductors', shares:3, avg:150, price:141.20, prev:143.0,
      ...
      news:[{date:'8 มิ.ย.', head:'การแข่งขัน AI chip กดดันมาร์จิ้นระยะสั้น', src:'Barrons', sum:'NVIDIA ยังครองส่วนแบ่ง GPU ตลาดหลัก AMD MI300X ได้ลูกค้าเพิ่มแต่ต้องลดราคาแข่ง ทำให้ gross margin ถูกกดดัน นักวิเคราะห์บางรายปรับลด PT ลง แต่มองว่าถ้า MI400 ออกมาแข่งขันได้จริงปลายปีนี้ภาพจะเปลี่ยน'},{date:'15 ก.พ. 2026', head:'AMD MI350 เปิดตัว — ประสิทธิภาพ AI inference ใกล้เคียง H100 ราคาถูกกว่า 18%', src:'Barrons', sum:'AMD Instinct MI350 ผ่านการทดสอบจากลูกค้าว่าประสิทธิภาพ AI inference ใกล้เคียง Nvidia H100 แต่ราคาต่ำกว่า 18% หลายองค์กรเริ่มกระจาย AI infrastructure ออกจาก NVDA ทำให้ AMD ได้ deal ใหม่ต่อเนื่อง'}]},
    {tk:'AAPL', name:'Apple', sector:'Technology', shares:1.5, avg:205, price:198.20, prev:199.5,
      ...
      news:[{date:'9 มิ.ย.', head:'ความคืบหน้า AI บนอุปกรณ์ยังช้ากว่าคู่แข่ง', src:'The Verge', sum:'Apple Intelligence ยังตามหลัง Google Gemini และ Microsoft Copilot ในด้าน on-device AI capability ผู้ใช้บางส่วนบ่นว่าฟีเจอร์ที่โฆษณาไว้ยังไม่มาครบ อย่างไรก็ตามกระแสเงินสดและโปรแกรม buyback ยังแข็งแกร่ง นักวิเคราะห์มองเป็น short-term headwind ไม่ใช่ structural problem'},{date:'10 ต.ค. 2025', head:'iPhone 17 launch แข็งแกร่ง ยอดสั่งซื้อล่วงหน้าทุบสถิติ', src:'Bloomberg', sum:'Apple รายงานยอดสั่งซื้อ iPhone 17 ล่วงหน้าสูงสุดในประวัติศาสตร์ Apple Intelligence กระตุ้นการอัปเกรดจากผู้ใช้ iPhone 13-14 ผู้วิเคราะห์ปรับ revenue estimate Q4 2025 ขึ้น 8-12%'},{date:'5 มิ.ย. 2025', head:'WWDC 2025 เปิดตัว Apple Intelligence 1.0 — AI on-device ครั้งแรก', src:'The Verge', sum:'Apple ประกาศ Apple Intelligence บน iOS 19 ฟีเจอร์ AI on-device แบบ privacy-first ตลาดตอบรับดี หุ้นขึ้น 4% ผู้วิเคราะห์มองเป็นจุดเริ่ม iPhone supercycle รุ่นถัดไป'}]}
  ],
  market:{
    indices:[
    ...
    holdings_news:[
      ...
      {tk:'GOOGL', head:'Google Cloud Q1 2026 revenue โต 28% — AI workload หนุนแรง', src:'Bloomberg', date:'25 เม.ย. 2026', sum:'Google Cloud รายได้ Q1 2026 โต 28% YoY ขับเคลื่อนด้วยดีมานด์ AI infrastructure จาก enterprise และ Gemini API ที่มีลูกค้าเพิ่ม 3x จากต้นปี Alphabet ปรับ capex guidance ขึ้นเป็น $75B สำหรับปี 2026'},
      {tk:'PLTR', head:'Palantir Q4 2025 — กำไร US Commercial โต 64% YoY ทุบ consensus', src:'Reuters', date:'18 ก.พ. 2026', sum:'Palantir รายงานผล Q4 2025 กำไร US Commercial segment โต 64% YoY สูงกว่า consensus 15% AIP มีลูกค้าองค์กรใหม่ 81 รายในไตรมาสเดียว บริษัทยกระดับ guidance ปี 2026 ขึ้น'}
    ]
  },
  arena:{
