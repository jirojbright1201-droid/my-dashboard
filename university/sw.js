// University PWA service worker (scope: /university/)
const CACHE = 'university-v1';
const CORE = [
  './', './index.html', './manifest.webmanifest',
  '../app.css', '../shared/boot.js',
  '../data/university-curriculum.data.js', '../views/university.js', '../views/university.css',
  '../icons/university-192.png', '../icons/university-512.png'
];
